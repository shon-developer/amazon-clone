    ...
    >
      {productData.map((item) => (
        <div
          ...
          hover:border-transparent shadow-none-testShadow duration-200 relative 
          flex flex-col gap-4"
        >
          ...
          >
            ...
            <ul
              ...
              justify-center gap-2 font-titleFont px-2 border-1 border-r 
          ...
          <div className="px-4 z-10 bg-white">
            <div className="flex items-center jusitfy-between px-4">
              <h1
                className="font-titleFont tracking-wide text-lg text-amazon-blue 
                font-medium"
              >
            ...
            from-yellow-400 to-yellow-200 border hover:from-yellow-400 border-yellow-300 hover:to-yellow-400
